...
var CoreModule = (function (_super) {
    ...
    CoreModule = __decorate([
        core_1.NgModule({
            ...
            providers: [data_filter_service_1.DataFilterService, sorter_1.Sorter, trackby_service_1.TrackByService, data_service_1.DataService] // these should be singleton
        }),
